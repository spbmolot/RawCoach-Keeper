...
class CouponSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        Coupon::firstOrCreate(
            ['code' => 'WELCOME20'], // Проверяем только по code
            [
        ...
        Coupon::firstOrCreate(
            ['code' => 'YEAR30'], // Проверяем только по code
            [
        ...
        Coupon::firstOrCreate(
            ['code' => 'PERSONAL500'], // Проверяем только по code
            [
        ...
        // Сезонная акция
        Coupon::firstOrCreate(
            ['code' => 'SPRING2024'], // Проверяем только по code
            [
        ...
        // Реферальный купон
        Coupon::firstOrCreate(
            ['code' => 'FRIEND10'], // Проверяем только по code
            [
